 ...
 *
 * @module lib/db/single-table/construct
 */
...
/**
 * Props for DdbSingleTableConstruct
 *
 * @property config - Application configuration object
 */
export interface IDdbSingleTableConstructProps {
 ...
 */
class DdbSingleTableConstruct extends Construct {
  /**
  ...
  constructor(
    scope: Construct,
    id: string,
    props: IDdbSingleTableConstructProps
  ) {
    super(scope, id);
...
export default DdbSingleTableConstruct;
